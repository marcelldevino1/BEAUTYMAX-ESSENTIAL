...
export default function BrandsPage() {
  ...
  return (
    <main className="pt-24 flex-grow pb-20 bg-[linear-gradient(to_bottom,#EADCE0_0%,#F5E6DF_25%,#EBBEC0_60%,#DDA8AB_100%)] min-h-screen relative overflow-hidden">
      ...
      <img src="/images/love-ornament.webp" alt="love" loading="lazy" className="absolute top-[38%] right-[10%] w-24 md:w-40 z-0 pointer-events-none opacity-90 drop-shadow-lg" />
        ...
        <section className="pt-12 md:pt-20 pb-16 md:pb-20 px-6 md:px-16 max-w-7xl mx-auto relative z-10">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-start mb-16">
            ...
            <div className="lg:col-span-6 flex flex-col gap-6 lg:pl-12">
              ...
              <div>
                <a href="#bk" className={`${glassButtonStyle} inline-block px-8 py-3 text-sm font-bold`}>
                  Explore Portfolio
                </a>
              </div>
            </div>
          ...
          <div className="md:col-span-5 order-2 md:order-1 flex flex-col justify-center">
            <ScrollReveal>
              <div className="mb-6 flex items-center gap-4">
                <h2 className="font-serif text-4xl md:text-5xl lg:text-6xl font-bold text-[#766350]">BK Cosmetics</h2>
              </div>
              
              {/* REVISI FONT: Menggunakan Palace Script MT */}
              <h3 className="text-[#766350] mb-6 font-normal tracking-wide" style={{ fontFamily: '"Palace Script MT", cursive', fontSize: '3.5rem', lineHeight: '1.1' }}>
                Beauty is never limited.
              </h3>
              
              <p className="text-base md:text-lg text-[#766350] font-medium mb-10 leading-relaxed max-w-md">
              ...
              <div className="flex flex-col gap-4 pt-4">
                <span className="text-sm font-bold uppercase tracking-widest text-[#766350]">Core Line — BUTYKISS</span>
                <span className="text-sm font-bold uppercase tracking-widest text-[#766350]">Core Line — BUTYKOOL</span>
                <span className="text-sm font-bold uppercase tracking-widest text-[#766350]">Core Line — BUTYKLEAN</span>
              </div>

              <h4 className="mt-12 text-xl font-bold uppercase tracking-widest text-[#766350] opacity-90">
        ...
        <div className="px-6 md:px-16 max-w-[90rem] mx-auto grid grid-cols-1 md:grid-cols-12 gap-12 md:gap-16 items-center">
          ...
          <div className="md:col-span-5 flex flex-col justify-center">
            <ScrollReveal delay={200}>
              <div className="mb-6">
                <h2 className="font-serif text-5xl md:text-6xl lg:text-7xl font-bold text-[#766350] mb-8">ME5</h2>
              </div>
              
              {/* REVISI FONT: Menggunakan Bauhaus 93 */}
              <h3 className="text-[#766350] mb-8 leading-tight tracking-wide drop-shadow-sm font-normal" style={{ fontFamily: '"Bauhaus 93", sans-serif', fontSize: '2.5rem' }}>
                Your Eyes. Your Magic. Your ME5.
              </h3>
              
              <p className="text-base md:text-lg text-[#766350] font-medium leading-relaxed max-w-md mb-12">
              ...
              <h4 className="text-xl md:text-2xl font-bold text-[#766350] opacity-90 drop-shadow-sm">
      ...
      <section className="w-full py-20 md:py-32 relative z-10" id="ag">
        <div className="px-6 md:px-16 max-w-[90rem] mx-auto grid grid-cols-1 md:grid-cols-12 gap-12 md:gap-16 items-center">
          ...
          <div className="md:col-span-5 order-2 md:order-1 flex flex-col justify-center">
            <ScrollReveal>
              <div className="mb-6">
                <h2 className="font-serif text-4xl md:text-5xl lg:text-6xl font-bold text-[#766350] mb-8">ANGELA GLAMOR</h2>
              </div>
              
              {/* REVISI FONT: Menggunakan Freestyle Script */}
              <h3 className="text-[#766350] mb-8 font-normal leading-snug tracking-wide" style={{ fontFamily: '"Freestyle Script", cursive', fontSize: '3.5rem' }}>
              ...
              <div className="flex flex-col gap-4 pt-4">
                <span className="text-sm font-bold text-[#766350]">Engineered Base Makeup</span>
                <span className="text-sm font-bold text-[#766350]">High-Gloss Gel Nails</span>
                <span className="text-sm font-bold text-[#766350]">Professional Salon Grade</span>
              </div>
            </ScrollReveal>
          </div>
